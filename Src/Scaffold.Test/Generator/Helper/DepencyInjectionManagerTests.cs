...
{
    [TestFixture]
    public class DepencyInjectionManagerTests
    {
        private DepencyInjectionManager depencyInjectionManager;
        ...
        public void SetUp()
        {
            ...
            depencyInjectionManager = new DepencyInjectionManager(fileSystemMock, configurationMock);
        }
...
";
            ...
            depencyInjectionManager.AddToCoreDependencyInjection("IBookRepository", "BookRepository", new[] { "Blah.Core.Domain.Repositories", "Blah.Core.Repositories" });
...
";
            ...
            depencyInjectionManager.AddToWebDependencyInjection("IBookRepository", "BookRepository", new[] { "Blah.Core.Domain.Repositories", "Blah.Core.Repositories" });
...
";
            ...
            depencyInjectionManager.AddToDependencyInjectionTest("IBookRepository", new[] { "Blah.Core.Domain.Repositories" });
